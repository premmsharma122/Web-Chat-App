...
const ProfilePage = () => {
    // FIX: Changed 'updatedProfile' to 'updateProfile' to match the context function name
...
            // FIX: Changed 'profilPic' to 'profilePic' to match backend field name
            await updateProfile({fullName: name, bio: bio, profilePic: base64String});
            navigate('/');
        }
        
    };
...
                    <textarea onChange={(e) => setBio(e.target.value)} value={bio} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' placeholder='write your bio...' rows={4}></textarea>
